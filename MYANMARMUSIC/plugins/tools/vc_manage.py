...
from MYANMARMUSIC.utils.database import get_assistant, set_loop
from MYANMARMUSIC.utils.permissions import adminsOnly
...
async def on_vc_start(_, msg):
    chat_id = msg.chat.id
    try:
        await msg.reply("<b>🤍 ᴠɪᴅᴇᴏ ᴄʜᴀᴛ sᴛᴀʀᴛᴇᴅ 🤍\n\n🙄 `ⁱᶠ ᵗʰᵉ ˢᵒⁿᵍ ᵈᵒᵉˢⁿ'ᵗ ᵖˡᵃʸ, ᵖˡᵉᵃˢᵉ ᵃˢᵏ ᶠᵒʳ ʰᵉˡᵖ = @typic2k4 { 🇲🇲 }</b>")
...
async def start_group_call(c: Client, m: Message):
    ...
    try:
        ...
        await msg.edit_text("<b>🎧 Voice Chat Started Successfully 🤍</b>")
        await set_loop(chat_id, 0)
...
async def stop_group_call(c: Client, m: Message):
    ...
    try:
        ...
        await msg.edit_text("<b>🎧 Voice Chat Closed Successfully 🤍</b>")
        await set_loop(chat_id, 0)
